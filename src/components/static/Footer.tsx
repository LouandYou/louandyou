      ...
      <div className="is-hidden-tablet">
        ...
        <div className="is-flex">
          <div className={styles.links_row}>
            <Link href="https://about.louandyou.org/imprint">
              {content.imprint}
            </Link>
            <Link href="https://about.louandyou.org/datenschutzerkl%C3%A4rung">
              {content.data}
            </Link>
            <Link href="https://about.louandyou.org/vereinssatzung">
              {content.bylaws}
            </Link>
          </div>
          <div className={styles.links_row}>
            <Link href="https://about.louandyou.org/accesibility">
              {content.accessibility}
            </Link>
            <Link href="https://about.louandyou.org/haftungsausschluss">
              {content.disclaimer}
            </Link>
          </div>
        </div>
