  ...
  return (
    <>
      <Head>
        <title>
          {locale === "en"
            ? "What's Good to Know about Domestic Violence"
            : "Überblick über Gewalt in Beziehungen"}
          | Lou&You
        </title>
        <meta
          name="description"
          content={
            locale === "en"
              ? `It’s not always easy to know whether you or someone else has experienced some form of domestic violence. Here is an overview to help you get a better idea.`
              : `Gewalt ist nicht immer so leicht als Gewalt zu erkennen. Hier findest du einen Überblick, der dir hilft, Gewalt in Beziehungen als solche wahrzunehmen.`
          }
        />
      </Head>
